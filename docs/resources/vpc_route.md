...
page_title: "stackit_vpc_route Resource - stackit"
subcategory: ""
description: |-
  VPC Route resource schema.
---

# stackit_vpc_route (Resource)
...
- `routing_table_id` (String) The routing table ID of the route.
...
- `updated_at` (String) Date-time when the route was last updated.
